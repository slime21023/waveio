...
final class DefaultContext implements Context {
    private final HttpRequest request; private final Registry registry; private final Chain chain; private final ResponseTransaction response;
    private boolean controlFlowSelected;
    DefaultContext(HttpRequest request, Registry registry, Chain chain, ResponseTransaction response) { this.request = Objects.requireNonNull(request, "request"); this.registry = Objects.requireNonNull(registry, "registry"); this.chain = Objects.requireNonNull(chain, "chain"); this.response = Objects.requireNonNull(response, "response"); }
