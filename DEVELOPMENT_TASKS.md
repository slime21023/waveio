...
| M7-07 | M7-05, M7-06 | 完成 | 建立 `CHANGELOG.md`、release notes、release dry-run 與 `0.1.0` GitHub Release 附件清單；不得自行發布。 | `scripts/release-dry-run.ps1` 確認 21 個 JAR 與附件清單；未進行外部發布。 |
